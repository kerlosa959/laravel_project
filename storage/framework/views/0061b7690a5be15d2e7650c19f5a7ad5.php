...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="tab-content" id="pills-tabContent">
                ...
                <div class="tab-pane fade" id="project" role="tabpanel" aria-labelledby="pills-contact-tab">
                    <?php
                        $modules=['project dashboard','project','milestone','grant chart','project stage','timesheet','expense','project task','activity','CRM activity','project task stage','bug report','bug status','labour request'];
                    ?>
                    <div class="col-md-12">
                        <div class="form-group">
                            <?php if(!empty($permissions)): ?>
                                ...
                                <table class="table table-striped mb-0" id="">
                                    ...
                                    <?php $__currentLoopData = $modules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $module): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <?php
                                            $moduleName=$module;
                                            if($module=='labour request')
                                            {
                                                $moduleName='Labour/Material request';
                                            }
                                            ...
                                            <td><label class="ischeck project_checkall" data-id="<?php echo e(str_replace(' ', '', $module)); ?>"><?php echo e(ucfirst($moduleName)); ?></label></td>
                                            <td>
                                                <div class="row ">
                                                    <?php if(in_array('view '.$module,(array) $permissions)): ?>
                                                        <?php if($key = array_search('view '.$module,$permissions)): ?>
                                                    ...
                                                    <?php if(in_array('trial balance '.$module,(array) $permissions)): ?>
                                                        ...
                                                        <?php endif; ?>
                                                    <?php endif; ?>
                                                    <?php if(in_array('accept '.$module,(array) $permissions)): ?>
                                                        <?php if($key = array_search('accept '.$module,$permissions)): ?>
                                                            <div class="col-md-3 custom-control custom-checkbox">
                                                                <?php echo e(Form::checkbox('permissions[]',$key,$role->permission, ['class'=>'form-check-input project_checkall isscheck_'.str_replace(' ', '', $module),'id' =>'permission'.$key])); ?>

                                                                <?php echo e(Form::label('permission'.$key,'Accept',['class'=>'custom-control-label'])); ?><br>
                                                            </div>
                                                        <?php endif; ?>
                                                    <?php endif; ?>

                                                    <?php if(in_array('reject '.$module,(array) $permissions)): ?>
                                                        <?php if($key = array_search('reject '.$module,$permissions)): ?>
                                                            <div class="col-md-3 custom-control custom-checkbox">
                                                                <?php echo e(Form::checkbox('permissions[]',$key,$role->permission, ['class'=>'form-check-input project_checkall isscheck_'.str_replace(' ', '', $module),'id' =>'permission'.$key])); ?>

                                                                <?php echo e(Form::label('permission'.$key,'Reject',['class'=>'custom-control-label'])); ?><br>
                                                            </div>
                                                        <?php endif; ?>
                                                    <?php endif; ?>
                                                </div>
...
<?php /**PATH /home/u188192483/domains/techzone.so/public_html/aldaar/resources/views/role/edit.blade.php ENDPATH**/ ?>