...
<div class="modal-body">
    ...
    <div class="col-sm-6 col-md-6">
            <div class="form-group">
                ...
                <?php echo Form::select('type', $types, $project->type,array('class' => 'form-control','required'=>'required')); ?>
	...
	<div class="col-sm-6 col-md-6">
            <div class="form-group">
                ...
                <?php echo Form::select('contract_type', $contract_type, $project->contract_type,array('class' => 'form-control','required'=>'required')); ?>
            ...
            <div class="form-group">
                ...
                <select name="priority" id="priority" class="form-control main-element">
                    <?php $__currentLoopData = \App\Models\Project::$project_priority; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($k); ?>" <?php echo e(($project->priority == $k) ? 'selected' : ''); ?>><?php echo e(__($v)); ?></option>
...
<?php /**PATH /home/u188192483/domains/techzone.so/public_html/aldaar/resources/views/projects/edit.blade.php ENDPATH**/ ?>