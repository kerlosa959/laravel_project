        ...
        <?php if(\Auth::user()->type != 'client'): ?>
            <ul class="dash-navbar">
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('show project dashboard')): ?>
                   ...
                   <li class="dash-item dash-hasmenu <?php echo e(Request::route()->getName() == 'project.dashboard' ? ' active' : ''); ?>">
                           <a href="<?php echo e(route('project.dashboard')); ?>" class="dash-link ">
                           <span class="dash-micon">
                                <i class="ti ti-home"></i>
                            </span><span
                                   class="dash-mtext"><?php echo e(__('Dashboard')); ?></span><span class="dash-arrow">
 ...
 <?php if(
    ...
    <li
        ...
        <ul class="dash-submenu">
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage labour request')): ?>
                <li
                    class="dash-item <?php echo e(Request::route()->getName() == 'labour-department.index' || Request::segment(1) == 'labour-department' || Request::route()->getName() == 'labour-department.edit' ? ' active' : ''); ?>">
                    <a class="dash-link" href="<?php echo e(route('labour-department.index')); ?>"><?php echo e(__('Labour Department')); ?></a>
                </li>
            <?php endif; ?>
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage labour request')): ?>
                <li
                    class="dash-item <?php echo e(Request::route()->getName() == 'labour.index' || Request::segment(1) == 'labour' || Request::route()->getName() == 'labour.edit' ? ' active' : ''); ?>">
                    <a class="dash-link" href="<?php echo e(route('labour.index')); ?>"><?php echo e(__('Labours')); ?></a>
                </li>
            <?php endif; ?>
    ...
    <?php if(Gate::check('manage project')): ?>
        <li
            ...
            <ul class="dash-submenu">
                ...
                <li
                    class="dash-item  <?php echo e(Request::route()->getName() == 'projecttype.index' || Request::route()->getName() == 'projecttype.show' ? 'active' : ''); ?>">
                    <a class="dash-link"
                        href="<?php echo e(route('projecttype.index')); ?>"><?php echo e(__('Project Type')); ?></a>
                </li>
                ...
                <?php if(Gate::check('manage project task stage') || Gate::check('manage bug status')): ?>
                    <li
                        ...
                        <a class="dash-link" href="#"><?php echo e(__('Project Setup')); ?><span
    ...
    <li class="dash-item dash-hasmenu">
        <a href="#!" class="dash-link ">
            <span class="dash-micon"><i class="ti ti-shopping-cart"></i></span><span
                class="dash-mtext"><?php echo e(__('Inventories')); ?></span><span class="dash-arrow">
...
<?php if(\Auth::user()->type != 'Logistics'): ?>
<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage labour request')): ?>
                   
<li class="dash-item dash-hasmenu <?php echo e(Request::segment(1) == 'projectlabours' || Request::route()->getName() == 'projectlabours.list' || Request::route()->getName() == 'projectlabours.list' || Request::route()->getName() == 'projectlabours.index' || Request::route()->getName() == 'projectlabours.show' || request()->is('projectlabours/*') ? 'active' : ''); ?>">
        <a href="<?php echo e(route('projectlabours.index','list')); ?>" class="dash-link ">
            <span class="dash-micon"><i class="ti ti-shopping-cart"></i></span><span
                class="dash-mtext"><?php echo e(__('Labour Requests')); ?></span><span class="dash-arrow">
...
<li class="dash-item dash-hasmenu <?php echo e(Request::segment(1) == 'projectmaterials' || Request::route()->getName() == 'projectmaterials.list' || Request::route()->getName() == 'projectmaterials.list' || Request::route()->getName() == 'projectmaterials.index' || Request::route()->getName() == 'projectmaterials.show' || request()->is('projectmaterials/*') ? 'active' : ''); ?>">
        <a href="<?php echo e(route('projectmaterials.index','list')); ?>" class="dash-link ">
            <span class="dash-micon"><i class="ti ti-shopping-cart"></i></span><span
                class="dash-mtext"><?php echo e(__('Material Requests')); ?></span><span class="dash-arrow">
...
<!--------------------- End Products System ----------------------------------->
                                ...
                                <?php if(\Auth::user()->type == 'company' || \Auth::user()->type == 'HR'): ?>
                                    <li
                                        ...
                                        Request::segment(1) == 'deductionoption'
                                            ...
                                            : ''); ?>">
                                        <a class="dash-link"
                                            href="<?php echo e(route('branch.index')); ?>"><?php echo e(__('HRM Setup')); ?></a>
                                    </li>
                                <?php endif; ?>

                                    <li
                                        class="dash-item dash-hasmenu  <?php echo e(Request::segment(1) == '' ? 'active dash-trigger' : ''); ?>">
                                        <a class="dash-link" href="#"><?php echo e(__('Letters')); ?><span
                                                class="dash-arrow"><i data-feather="chevron-right"></i></span></a>
                                        <ul class="dash-submenu">

                                            <li class="dash-item <?php echo e(request()->is('') ? 'active' : ''); ?>">
                                                <a class="dash-link" href="<?php echo e(route('letters')); ?>#offer-letter-settings"><?php echo e(__('Offer Letter Settings')); ?></a>
                                            </li>
                                            <li class="dash-item <?php echo e(request()->is('') ? 'active' : ''); ?>">
                                                <a class="dash-link" href="<?php echo e(route('letters')); ?>#joining-letter-settings"><?php echo e(__('Joining Letter Settings')); ?></a>
                                            </li>
                                            <li class="dash-item <?php echo e(request()->is('') ? 'active' : ''); ?>">
                                                <a class="dash-link" href="<?php echo e(route('letters')); ?>#experience-certificate-settings"><?php echo e(__('Experience Certificate Settings')); ?></a>
                                            </li>
                                            <li class="dash-item <?php echo e(request()->is('') ? 'active' : ''); ?>">
                                                <a class="dash-link" href="<?php echo e(route('letters')); ?>#noc-settings"><?php echo e(__('NOC Settings')); ?></a>
                                            </li>
                                        </ul>
                                    </li>
                        </ul>
                ...
                <?php if(
                    ...
                    <li
                        ...
                        <a href="#!" class="dash-link"><span class="dash-micon"><i
                                ...
                                class="dash-mtext"><?php echo e(__('Accounting')); ?>
                        ...
                        <ul class="dash-submenu">
                          ...
                          <!-- double entry st -->
                            <?php if(Gate::check('manage chart of account')): ?>
                                <li class="dash-item <?php echo e(Request::segment(1) == 'chart-of-account' || Request::route()->getName() == 'chart-of-account.index' || Request::route()->getName() == 'chart-of-account.show' ? 'active' : ''); ?>">
                                    <a class="dash-link"
                                        href="<?php echo e(route('chart-of-account.index')); ?>"><?php echo e(__('Chart of Accounts')); ?></a>
                                </li>
                            <?php endif; ?>

                            <?php if(Gate::check('manage journal entry')): ?>
                                <li class="dash-item <?php echo e(Request::segment(1) == 'journal-entry' || Request::route()->getName() == 'journal-entry.edit' ||
                            ...
                            <?php if(Gate::check('ledger report')): ?>
                                <li class="dash-item <?php echo e(Request::segment(2) == 'ledger' || Request::route()->getName() == 'report.ledger' ? 'active' : ''); ?>">
                                    <a class="dash-link"
                                        href="<?php echo e(route('report.ledger', 0)); ?>"><?php echo e(__('Ledger Summary')); ?></a>
                                </li>
                            <?php endif; ?>

                            <?php if(Gate::check('balance sheet report')): ?>
                                <li class="dash-item <?php echo e(Request::segment(2) == 'balance-sheet' || Request::route()->getName() == 'report.balance.sheet' ? 'active' : ''); ?>">
                                    <a class="dash-link"
                            ...
                            <?php if(Gate::check('trial balance report')): ?>
                                <li class="dash-item <?php echo e(Request::segment(2) == 'trial-balance' || Request::route()->getName() == 'trial.balance' ? 'active' : ''); ?>">
                                    <a class="dash-link"
        ...
        <?php if(Gate::check('manage vender') ||
            ...
            <li
                ...
                <a class="dash-link" href="#"><span class="dash-micon"><i
                                    class="ti ti-layers-difference"></i></span>
                                    <span class="dash-mtext"><?php echo e(__('Purchases')); ?></span>
                                    <span class="dash-arrow"><i data-feather="chevron-down"></i></span></a>
                <ul class="dash-submenu">
                    <?php if(Gate::check('manage vender')): ?>
                        <li
                ...
                <?php if(Gate::check('manage lead') ||
                    ...
                    <?php if(Gate::check('manage lead stage') ||
                        ...
                        <li
                            ...
                            <a class="dash-link"
                                href="<?php echo e(route('pipelines.index')); ?>   "><?php echo e(__('CRM Setup')); ?></a>
...
<?php /**PATH C:\wamp64\www\aldar_live\resources\views/partials/admin/menu.blade.php ENDPATH**/ ?>