                    ...
                    <div class="card">
                        <div class="card-header border-0 pb-0">
                            <div class="d-flex align-items-center">
                                ...
                                <h5 class="mb-0"><a class="text-dark" href="<?php echo e(route('projects.show',$project)); ?>"><?php echo e($project->project_name." (".$project->project_no.")"); ?></a></h5>
                            </div>
                        ...
                        <div class="card-body">
							...
							<?php if(!is_null($project->contract_type)): ?>
							
                                <div class="col-auto text-right"><span class="badge rounded-pill bg-<?php echo e(\App\Models\Project::$contract_color[$project->contract_type]); ?>"><?php echo e($project->contract_type); ?></span>
                                </div>
                            ...
                            <div class="card mb-0 mt-3">
                                <div class="card-body p-3">
                                    <div class="row">
										...
										<?php if(!is_null($project->end_date) && $project->end_date!='0000-00-00'  && $project->end_date!='1970-01-01'): ?>
...
<?php endif; ?>
<?php /**PATH /home/u188192483/domains/techzone.so/public_html/aldaar/resources/views/projects/grid.blade.php ENDPATH**/ ?>