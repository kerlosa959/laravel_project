        ...
        <table class="add-border proposal-summary" style="margin-top: 30px;">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    ?>
                                <td><?php echo e($item->quantity . ' (' . !empty($unitName) ? $unitName->name : '' . ')'); ?></td>
...
<?php /**PATH /home/u188192483/domains/techzone.so/public_html/aldaar/resources/views/proposal/templates/template1.blade.php ENDPATH**/ ?>