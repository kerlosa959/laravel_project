<?php $__env->startSection('page-title'); ?>
    <?php echo e(__('Manage Material Requests')); ?>
...
<?php $__env->startSection('breadcrumb'); ?>
    ...
    <li class="breadcrumb-item"><?php echo e(__('Material Requests')); ?></li>
<?php $__env->stopSection(); ?>
<style>
...
<?php $__env->startSection('action-btn'); ?>
    <div class="float-end">
        ...
        <?php if( \Auth::user()->type!='company' && \Auth::user()->type!='Accountant'  && \Auth::user()->type!='Manager' && \Auth::user()->type!='Logistics'): ?>
            <a href="#" data-size="lg" data-url="<?php echo e(route('projectmaterials.create')); ?>" data-ajax-popup="true" data-bs-toggle="tooltip" title="<?php echo e(__('Create New Request')); ?>" data-title="<?php echo e(__('Create New Request')); ?>" class="btn btn-sm btn-primary">
...
<?php $__env->startPush('script-page'); ?>
    <script>
        ...
        function ajaxFilterProjectView(project_sort, keyword = '', status = '') {
            ...
            currentRequest = $.ajax({
                url: '<?php echo e(route('filter.projectmaterial.view')); ?>',
                data: data,
                beforeSend: function () {
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u188192483/domains/techzone.so/public_html/aldaar/resources/views/projectmaterialrequest/index.blade.php ENDPATH**/ ?>