...
<body class="<?php echo e($color); ?>">
    <div class="custom-login">
        ...
        <div class="custom-login-inner">
                ...
                <nav class="navbar navbar-expand-md default">
                    <div class="container">
                        ...
                        <a class="navbar-brand" href="#">
                            <?php if($setting['cust_darklayout'] == 'on'): ?>
                                <img class="logo"
                                    src="https://aldaar.techzone.so/storage/uploads/logo//2-logo-dark.png"
                                    alt="" loading="lazy"/>
                            <?php else: ?>
                                <img class="logo"
                                    src="https://aldaar.techzone.so/storage/uploads/logo//2-logo-dark.png"
            ...
            <main class="custom-wrapper custom_wrapper">
            <div class="container">
...
<br>
                        ...
                        <!-- <div class="col-md-6">
                            <div class="AppFormRight position-relative d-flex justify-content-center flex-column align-items-center text-center p-5 text-white">
                                <h2 class="position-relative px-4 pb-3 mb-4 text-white">Welcome</h2>
                                <p>We are delighted to welcome you to RedERP, where efficiency meets innovation. As you embark on this journey with us, you are now part of a dynamic platform designed to streamline and enhance your business processes.</p>
                            </div> 
                            &nbsp;
                        </div> -->
                    </div>
...
<?php /**PATH /home/u188192483/domains/techzone.so/public_html/aldaar/resources/views/layouts/auth.blade.php ENDPATH**/ ?>