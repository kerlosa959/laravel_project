...
<?php $__env->startSection('breadcrumb'); ?>
    <li class="breadcrumb-item"><a href="<?php echo e(route('project.dashboard')); ?>"><?php echo e(__('Dashboard')); ?></a></li>
                        ...
                        <?php $__currentLoopData = $home_data['project_status']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-sm-3">
                                <div class="align-items-start">
                                    ...
                                    <div class="ms-2">
                                        <p class="text-muted mb-0"><?php echo e(__(\App\Models\Project::$project_status[$status])); ?></p>
                                        <h5 class="mb-1 text-<?php echo e(\App\Models\Project::$status_color[$status]); ?>"><?php echo e($val['total']); ?>%</h5>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    <div id="task_overview" style="min-height: 300px;"></div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u188192483/domains/techzone.so/public_html/aldaar/resources/views/dashboard/project-dashboard.blade.php ENDPATH**/ ?>