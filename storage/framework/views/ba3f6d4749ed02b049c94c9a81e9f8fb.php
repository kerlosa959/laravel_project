...
<?php $__env->startSection('action-btn'); ?>
    <div class="float-end">
        ...
        <form method="GET" action="<?php echo e(route('labours.search')); ?>">
...
<?php if(isset($labours) && $labours->count() > 0): ?>
    <table class="table">
        <thead>
            <tr>
                <th>Name</th>
        ...
        <tbody>
            <?php $__currentLoopData = $labours; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $labour): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td><?php echo e($labour->mobile); ?></td>
                    <td>
                        <form method="POST" action="<?php echo e(route('labours.add', $labour->id)); ?>">
                            <?php echo csrf_field(); ?>
...
<?php if(isset($selectedLabour)): ?>
    <h2>Labour Details</h2>
    <p>Name: <?php echo e($selectedLabour->name); ?></p>
    <p>Mobile: <?php echo e($selectedLabour->mobile); ?></p>
    <!-- Add more fields as needed -->
<?php endif; ?>


<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\aldar_live\resources\views/projectworkerrequest/index.blade.php ENDPATH**/ ?>