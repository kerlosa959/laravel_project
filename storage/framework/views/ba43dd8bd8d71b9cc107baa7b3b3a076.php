...
<div class="modal-body">
    ...
    <div class="row">
        <div class="form-group col-sm-12 col-md-12">
            <?php echo e(Form::label('project_image', __('Upload Documents'), ['class' => 'form-label'])); ?><span class="text-danger">*</span>
        ...
        <div class="col-sm-6 col-md-6">
            <div class="form-group">
                <?php echo e(Form::label('user', __('Manager'),['class'=>'form-label'])); ?><span class="text-danger">*</span>
                <?php echo Form::select('user[]', $manager, null,array('class' => 'form-control select2','required'=>'required')); ?>
        ...
        <div class="col-sm-6 col-md-6">
            <div class="form-group">
                ...
                <?php echo Form::select('type', $types, null,array('class' => 'form-control','required'=>'required')); ?>

            </div>
        </div>
		 <div class="col-sm-6 col-md-6">
            <div class="form-group">
                <?php echo e(Form::label('contract_type', __('Contract Type'),['class'=>'form-label'])); ?><span class="text-danger">*</span>
                <?php echo Form::select('contract_type', $contract_type, null,array('class' => 'form-control','required'=>'required')); ?>

            </div>
        </div>
        <div class="col-sm-6 col-md-6">
            <div class="form-group">
                <?php echo e(Form::label('space', __('Size'), ['class' => 'form-label'])); ?>

                <?php echo e(Form::text('space', null, ['class' => 'form-control'])); ?>
        ...
        <div class="col-6 col-md-6">
            <div class="form-group">
                <?php echo e(Form::label('estimated_hrs', __('Estimated Months'),['class' => 'form-label'])); ?>
    ...
    <div class="row">
        <div class="col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <select name="priority" id="priority" class="form-control main-element">
                    <?php $__currentLoopData = \App\Models\Project::$project_priority; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH /home/u188192483/domains/techzone.so/public_html/aldaar/resources/views/projects/create.blade.php ENDPATH**/ ?>