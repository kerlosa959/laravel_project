                    ...
                    <div class="table-responsive">
                        <table class="table datatable">
                            ...
                            <tr>
								...
								<th><?php echo e(__('Min Quantity')); ?></th>
                            ...
                            <?php $__currentLoopData = $productServices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $productService): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="font-style">
                                    ...
                                    <?php endif; ?>
									 <?php if($productService->type == 'product'): ?>
                                        <td><?php echo e($productService->min_quantity); ?></td>
                                    <?php else: ?>
                                        <td>-</td>
                                    <?php endif; ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u188192483/domains/techzone.so/public_html/aldaar/resources/views/productservice/index.blade.php ENDPATH**/ ?>