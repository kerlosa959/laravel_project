            ...
            <div class="col-sm-12">
                <div class="row">
                    ...
                    <div class="col-md-4">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="mt-1 mb-0"><?php echo e(__('Staff')); ?></h5>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6 col-6 my-2">
                                            <div class="d-flex align-items-start mb-2">
                                                ...
                                                <div class="ms-2">
                                                    ...
                                                    <h4 class="mb-0 text-primary"><?php echo e($countUser +   $countClient); ?></h4>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-6 my-2">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="mt-1 mb-0"><?php echo e(__('Job')); ?></h5>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6 col-6 my-2">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="mt-1 mb-0"><?php echo e(__('Training')); ?></h5>
                                </div>
                                <div class="card-body">                                   
                                    <div class="row">
                                        <div class="col-md-6 col-6 my-2">
                                            <div class="d-flex align-items-start mb-2">
                                                ...
                                                <div class="ms-2">
                                                    ...
                                                    <h4 class="mb-0 text-primary"><?php echo e($onGoingTraining +   $doneTraining); ?></h4>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u188192483/domains/techzone.so/public_html/aldaar/resources/views/dashboard/dashboard.blade.php ENDPATH**/ ?>