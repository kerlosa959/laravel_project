    ...
    <div class="row">
        <div class="form-group col-sm-12 col-md-12">
            ...
            <div class="form-file mb-3">
                ...
                <input type="file" class="from-control" name="project_exl"required="">
                <input type="file" class="from-control" name="project_pdf"required="">
                <input type="file" class="from-control" name="project_words"required="">
            </div>
        ...
        <div class="col-sm-6 col-md-6">
            <div class="form-group">
                {{ Form::label('user', __('Manager'),['class'=>'form-label']) }}<span class="text-danger">*</span>
                {!! Form::select('user[]', $manager, null,array('class' => 'form-control select2','required'=>'required')) !!}
            </div>
        </div>
       {{--  <div class="col-sm-6 col-md-6">
            <div class="form-group">
                {{ Form::label('supervisor', __('Supervisor'),['class'=>'form-label']) }}<span class="text-danger">*</span>
                {!! Form::select('supervisor[]', $supervisor, null,array('class' => 'form-control select2','required'=>'required')) !!}
            </div>
	   </div> --}}
        <div class="col-sm-6 col-md-6">
            <div class="form-group">
		 ...
		 <div class="col-sm-6 col-md-6">
            <div class="form-group">
                {{ Form::label('contract_type', __('Contract Type'),['class'=>'form-label']) }}<span class="text-danger">*</span>
                {!! Form::select('contract_type', $contract_type, null,array('class' => 'form-control','required'=>'required')) !!}
            </div>
        </div>
        <div class="col-sm-6 col-md-6">
            <div class="form-group">
                {{ Form::label('space', __('Size'), ['class' => 'form-label']) }}
        ...
        <div class="col-6 col-md-6">
            <div class="form-group">
                {{ Form::label('estimated_hrs', __('Estimated Months'),['class' => 'form-label']) }}
        ...
        <div class="col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <select name="priority" id="priority" class="form-control main-element">
                    @foreach(\App\Models\Project::$project_priority as $k => $v)
