                    ...
                    <div class="card">
                        <div class="card-header border-0 pb-0">
                            <div class="d-flex align-items-center">
                                ...
                                <h5 class="mb-0"><a class="text-dark" href="{{ route('projects.show',$project) }}">{{ $project->project_name." (".$project->project_no.")" }}</a></h5>
                            </div>
                        ...
                        <div class="card-body">
							...
							@if(!is_null($project->contract_type))
							
                                <div class="col-auto text-right"><span class="badge rounded-pill bg-{{\App\Models\Project::$contract_color[$project->contract_type]}}">{{ $project->contract_type }}</span>
                                </div>
                            ...
                            <div class="card mb-0 mt-3">
                                <div class="card-body p-3">
                                    <div class="row">
										...
										@if(!is_null($project->end_date) && $project->end_date!='0000-00-00'  && $project->end_date!='1970-01-01')
