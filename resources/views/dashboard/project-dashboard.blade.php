...
@endpush
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{route('project.dashboard')}}">{{__('Dashboard')}}</a></li>
                        ...
                        @foreach($home_data['project_status'] as $status => $val)
                            <div class="col-sm-3">
                                <div class="align-items-start">
                                    ...
                                    <div class="ms-2">
                                        <p class="text-muted mb-0">{{__(\App\Models\Project::$project_status[$status])}}</p>
                                        <h5 class="mb-1 text-{{ \App\Models\Project::$status_color[$status] }}">{{ $val['total'] }}%</h5>
