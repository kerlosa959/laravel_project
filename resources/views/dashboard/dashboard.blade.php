            ...
            <div class="col-sm-12">
                <div class="row">
                    ...
                    <div class="col-md-4">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="mt-1 mb-0">{{__('Staff')}}</h5>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6 col-6 my-2">
                                            <div class="d-flex align-items-start mb-2">
                                                ...
                                                <div class="ms-2">
                                                    ...
                                                    <h4 class="mb-0 text-primary">{{ $countUser +   $countClient}}</h4>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-6 my-2">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="mt-1 mb-0">{{__('Training')}}</h5>
                                </div>
                                <div class="card-body">                                   
                                    <div class="row">
                                        <div class="col-md-6 col-6 my-2">
                                            <div class="d-flex align-items-start mb-2">
                                                ...
                                                <div class="ms-2">
                                                    ...
                                                    <h4 class="mb-0 text-primary">{{ $onGoingTraining +   $doneTraining}}</h4>
