                        ...
                        @foreach($crm_data['lead_status'] as $status => $val)
                            <div class="col-md-12 col-sm-12 mb-3">
                                <div class="align-items-start">
                                    <div class="ms-2">
                                        <p class="text-muted mb-0">{{$val['lead_stage']}}</p>
                                        <h5 class="mb-1 text-primary">{{ $val['lead_percentage'] }}%</h5>
                    ...
                    <div class="row ">
                        @foreach($crm_data['deal_status'] as $status => $val)
                            <div class="col-md-12 col-sm-12 mb-3">
                                <div class="align-items-start">
                                    <div class="ms-2">
                                        <p class="text-muted mb-0">{{$val['deal_stage']}}</p>
                                        <h5 class="mb-1 text-primary">{{ $val['deal_percentage'] }}%</h5>
                                        <div class="progress mb-0">
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            @forelse($crm_data['latestContract'] as $contract)
                                <tr>
                                    <td>
                                        <a href="{{route('contract.show',$contract->id)}}" class="btn btn-sm btn-outline-primary">{{\Auth::user()->contractNumberFormat($contract->id)}}</a>
                                    </td>
