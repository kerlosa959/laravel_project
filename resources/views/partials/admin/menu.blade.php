        ...
        @if (\Auth::user()->type != 'client')
            <ul class="dash-navbar">
                @can('show project dashboard')
                   ...
                   <li class="dash-item dash-hasmenu {{ Request::route()->getName() == 'project.dashboard' ? ' active' : '' }}">
                           <a href="{{route('project.dashboard')}}" class="dash-link ">
                           <span class="dash-micon">
                                <i class="ti ti-home"></i>
                            </span><span
                                   class="dash-mtext">{{ __('Dashboard') }}</span><span class="dash-arrow">
 ...
 @if (
    ...
    <li
        ...
        <ul class="dash-submenu">
            ...
            @can('manage labour request')
                <li
                    class="dash-item {{ Request::route()->getName() == 'labour-department.index' || Request::segment(1) == 'labour-department' || Request::route()->getName() == 'labour-department.edit' ? ' active' : '' }}">
                    <a class="dash-link" href="{{ route('labour-department.index') }}">{{ __('Labour Department') }}</a>
                </li>
            @endcan
            @can('manage labour request')
                <li
                    class="dash-item {{ Request::route()->getName() == 'labour.index' || Request::segment(1) == 'labour' || Request::route()->getName() == 'labour.edit' ? ' active' : '' }}">
                    <a class="dash-link" href="{{ route('labour.index') }}">{{ __('Labours') }}</a>
                </li>
            @endcan
...
@if (!empty($userPlan) && $userPlan->project == 1)
    @if (Gate::check('manage project'))
        <li class="dash-item dropdown {{ Request::segment(1) == 'project' || Request::segment(1) == 'bugs-report' || Request::segment(1) == 'bugstatus' || Request::segment(1) == 'project-task-stages' || Request::segment(1) == 'calendar' || Request::segment(1) == 'timesheet-list' || Request::segment(1) == 'taskboard' || Request::segment(1) == 'projects' || Request::segment(1) == 'project_report' ? 'active dash-trigger' : '' }}">
            ...
            <ul class="dash-submenu">
                @can('manage project')
                    <li class="dash-item dropdown {{ Request::segment(1) == 'project' || Request::route()->getName() == 'projects.list' || Request::route()->getName() == 'projects.index' || Request::route()->getName() == 'projects.show' || request()->is('projects/*') ? 'active' : '' }}">
                        <a class="dash-link" href="{{ route('projects.index') }}">{{ __('Projects') }}</a>
                    </li>
                @endcan
                @can('manage project task')
                    <li class="dash-item dropdown {{ request()->is('taskboard*') ? 'active' : '' }}">
                        <a class="dash-link" href="{{ route('taskBoard.view', 'list') }}">{{ __('Tasks') }}</a>
                    </li>
                @endcan
                @can('manage timesheet')
                    <li class="dash-item dropdown {{ request()->is('timesheet-list*') ? 'active' : '' }}">
                        <a class="dash-link" href="{{ route('timesheet.list') }}">{{ __('Timesheet') }}</a>
                    </li>
                @endcan
                @can('manage project task')
                    <li class="dash-item dropdown {{ request()->is('calendar*') ? 'active' : '' }}">
                        <a class="dash-link" href="{{ route('task.calendar', ['all']) }}">{{ __('Task Calendar') }}</a>
                    </li>
                @endcan
                @if (\Auth::user()->type != 'super admin')
                    <li class="dash-item dropdown {{ Request::segment(1) == 'time-tracker' ? 'active open' : '' }}">
                        <a class="dash-link" href="{{ route('time.tracker') }}">{{ __('Tracker') }}</a>
                    </li>
                @endif
                @if (\Auth::user()->type == 'company' || \Auth::user()->type == 'Employee')
                    <li class="dash-item dropdown {{ Request::route()->getName() == 'project_report.index' || Request::route()->getName() == 'project_report.show' ? 'active' : '' }}">
                        <a class="dash-link" href="{{ route('project_report.index') }}">{{ __('Project Report') }}</a>
                    </li>
                @endif
                <li class="dash-item dropdown {{ Request::route()->getName() == 'projecttype.index' || Request::route()->getName() == 'projecttype.show' ? 'active' : '' }}">
                    <a class="dash-link" href="{{ route('projecttype.index') }}">{{ __('Project Type') }}</a>
                </li>
                @if (Gate::check('manage project task stage') || Gate::check('manage bug status'))
                    <li class="dash-item dropdown {{ Request::segment(1) == 'bugstatus' || Request::segment(1) == 'project-task-stages' ? 'active dash-trigger' : '' }}">
                        <a class="dash-link dropdown-toggle" href="#">{{ __('Project Setup') }}<span class="dash-arrow"><i data-feather="chevron-right"></i></span></a>
                        <ul class="dash-submenu">
                            @can('manage project task stage')
                                <li class="dash-item dropdown {{ Request::route()->getName() == 'project-task-stages.index' ? 'active' : '' }}">
                                    <a class="dash-link" href="{{ route('project-task-stages.index') }}">{{ __('Project Task Stages') }}</a>
                                </li>
                            @endcan
                            @can('manage bug status')
                                <li class="dash-item dropdown {{ Request::route()->getName() == 'bugstatus.index' ? 'active' : '' }}">
...
<li class="dash-item dash-hasmenu {{ Request::segment(1) == 'projectlabours' || Request::route()->getName() == 'projectlabours.list' || Request::route()->getName() == 'projectlabours.list' || Request::route()->getName() == 'projectlabours.index' || Request::route()->getName() == 'projectlabours.show' || request()->is('projectlabours/*') ? 'active' : ''}}">
        <a href="{{route('projectlabours.index','list')}}" class="dash-link ">
            <span class="dash-micon"><i class="ti ti-shopping-cart"></i></span><span
                class="dash-mtext">{{ __('Labour Requests') }}</span><span class="dash-arrow">
...
<li class="dash-item dash-hasmenu {{ Request::segment(1) == 'projectmaterials' || Request::route()->getName() == 'projectmaterials.list' || Request::route()->getName() == 'projectmaterials.list' || Request::route()->getName() == 'projectmaterials.index' || Request::route()->getName() == 'projectmaterials.show' || request()->is('projectmaterials/*') ? 'active' : ''}}">
        <a href="{{route('projectmaterials.index','list')}}" class="dash-link ">
            <span class="dash-micon"><i class="ti ti-shopping-cart"></i></span><span
                class="dash-mtext">{{ __('Material Requests') }}</span><span class="dash-arrow">
                                ...
                                @if (\Auth::user()->type == 'company' || \Auth::user()->type == 'HR')
                                    <li
                                        ...
                                        Request::segment(1) == 'deductionoption'
                                            ...
                                            : '' }}">
                                        <a class="dash-link"
                                            href="{{ route('branch.index') }}">{{ __('HRM Setup') }}</a>
                                    </li>
                                @endcan

                                    <li
                                        class="dash-item dash-hasmenu  {{ Request::segment(1) == '' ? 'active dash-trigger' : '' }}">
                                        <a class="dash-link" href="#">{{ __('Letters') }}<span
                                                class="dash-arrow"><i data-feather="chevron-right"></i></span></a>
                                        <ul class="dash-submenu">

                                            <li class="dash-item {{ request()->is('') ? 'active' : '' }}">
                                                <a class="dash-link" href="{{ route('letters') }}#offer-letter-settings">{{ __('Offer Letter Settings') }}</a>
                                            </li>
                                            <li class="dash-item {{ request()->is('') ? 'active' : '' }}">
                                                <a class="dash-link" href="{{ route('letters') }}#joining-letter-settings">{{ __('Joining Letter Settings') }}</a>
                                            </li>
                                            <li class="dash-item {{ request()->is('') ? 'active' : '' }}">
                                                <a class="dash-link" href="{{ route('letters') }}#experience-certificate-settings">{{ __('Experience Certificate Settings') }}</a>
                                            </li>
                                            <li class="dash-item {{ request()->is('') ? 'active' : '' }}">
                                                <a class="dash-link" href="{{ route('letters') }}#noc-settings">{{ __('NOC Settings') }}</a>
                                            </li>
                                        </ul>
                                    </li>
                        </ul>
                        ...
                        <ul class="dash-submenu">
                          ...
                          <!-- double entry st -->
                            @if (Gate::check('manage chart of account'))
                                <li class="dash-item {{ Request::segment(1) == 'chart-of-account' || Request::route()->getName() == 'chart-of-account.index' || Request::route()->getName() == 'chart-of-account.show' ? 'active' : '' }}">
                                    <a class="dash-link"
                            ...
                            @if (Gate::check('manage journal entry'))
                                <li class="dash-item {{ Request::segment(1) == 'journal-entry' || Request::route()->getName() == 'journal-entry.edit' ||
                            ...
                            @if (Gate::check('ledger report'))
                                <li class="dash-item {{ Request::segment(2) == 'ledger' || Request::route()->getName() == 'report.ledger' ? 'active' : '' }}">
                                    <a class="dash-link"
                                        href="{{ route('report.ledger', 0) }}">{{ __('Ledger Summary') }}</a>
                                </li>
                            @endif

                            @if (Gate::check('balance sheet report'))
                                <li class="dash-item {{ Request::segment(2) == 'balance-sheet' || Request::route()->getName() == 'report.balance.sheet' ? 'active' : '' }}">
                                    <a class="dash-link"
                            ...
                            @if (Gate::check('trial balance report'))
                                <li class="dash-item {{ Request::segment(2) == 'trial-balance' || Request::route()->getName() == 'trial.balance' ? 'active' : '' }}">
                                    <a class="dash-link"
                ...
                @if (Gate::check('manage lead') ||
                    ...
                    @if (Gate::check('manage lead stage') ||
                        ...
                        <li
                            ...
                            <a class="dash-link"
                                href="{{ route('pipelines.index') }}   ">{{ __('CRM Setup') }}</a>
        ...
        @if (!empty($userPlan) &&  $userPlan->pos == 1)
            @if (Gate::check('manage warehouse') ||
                ...
                <li
                    ...
                    <a href="#!" class="dash-link"><span class="dash-micon"><i
                                class="ti ti-layers-difference"></i></span><span
                            class="dash-mtext">{{ __('POS') }}</span><span class="dash-arrow"><i
                                data-feather="chevron-right"></i></span></a>
                    <ul
                ...
                <li
                    ...
                    <ul class="dash-submenu">
                        @if (Gate::check('manage company settings'))
                            ...
                            <li
                                class="dash-item dash-hasmenu {{ Request::segment(1) == 'settings' ? 'active dash-trigger' : '' }}">
                                <a class="dash-link" href="#">{{ __('System Settings') }}<span
                                        class="dash-arrow"><i data-feather="chevron-right"></i></span></a>
                                <ul class="dash-submenu">
                                    <li class="dash-item"><a class="dash-link" href="{{ route('settings') }}#system-settings">{{ __('System Settings') }}</a></li>
                                    <li class="dash-item"><a class="dash-link" href="{{ route('settings') }}#company-settings">{{ __('Company Settings') }}</a></li>
                                    <li class="dash-item"><a class="dash-link" href="{{ route('settings') }}#email-settings">{{ __('Email Settings') }}</a></li>
                                    <li class="dash-item"><a class="dash-link" href="{{ route('settings') }}#tracker-settings">{{ __('Time Tracker Settings') }}</a></li>
                                    <li class="dash-item"><a class="dash-link" href="{{ route('settings') }}#payment-settings">{{ __('Payment Settings') }}</a></li>
                                    <li class="dash-item"><a class="dash-link" href="{{ route('settings') }}#twilio-settings">{{ __('Twilio Settings') }}</a></li>
                                    <li class="dash-item"><a class="dash-link" href="{{ route('settings') }}#email-notification-settings">{{ __('Email Notification Settings') }}</a></li>
                                    <li class="dash-item"><a class="dash-link" href="{{ route('settings') }}#google-calender">{{ __('Google Calendar Settings') }}</a></li>
                                    <li class="dash-item"><a class="dash-link" href="{{ route('settings') }}#webhook-settings">{{ __('Webhook Settings') }}</a></li>
                                    <li class="dash-item"><a class="dash-link" href="{{ route('settings') }}#ip-restriction-settings">{{ __('IP Restriction Settings') }}</a></li>
                                </ul>
                            </li>
