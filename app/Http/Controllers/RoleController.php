...
class RoleController extends Controller
{
    ...
    public function index()
    {
        ...
        // // $permission=Permission::insert($arrPermissions);
        // $permission=Permission::whereIn('id',array(526,527))->get();
        // // echo "<pre>";
        // // print_r($permission);
        // // die();

        // $companyRole=Role::where('name', '=', 'Accountant')->first();
        // $companyRole->givePermissionTo($permission);
        // $companyRole=Role::where('name', '=', 'Manager')->first();
        // $companyRole->givePermissionTo($permission);
        // $companyRole=Role::where('name', '=', 'Supervisor')->first();
        // $companyRole->givePermissionTo($permission);
        // // echo "<pre>";
        // // print_r($companyRole);
        // // print_r($companyRole->getAllPermissions());
        ...
        // $sRole=Role::where('name', '=', 'Supervisor')->first();
        // $sRole->givePermissionTo($permission);
