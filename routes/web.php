...
use App\Http\Controllers\LabourDepartmentController;
...
use App\Http\Controllers\ProjectWorkerRequestController;
use App\Http\Controllers\ProjectMaterialRequestController;
...
Route::group(['middleware' => ['verified']], function () {
    ...
    Route::group(
        [
            ...
            Route::get('settings-letters', [SystemController::class, 'letters'])->name('letters'); // Added by PC
...
//        Route::get('report/profit-loss-summary', [ReportController::class, 'profitLossSummary'])->name('report.profit.loss.summary');
    ...
    Route::resource('labour', LabourController::class)->middleware(['auth', 'XSS']);
    Route::resource('department', DepartmentController::class)->middleware(['auth', 'XSS']);
    Route::resource('labour-department', LabourDepartmentController::class)->middleware(['auth', 'XSS']);
    ...
    Route::post('department/fetch', [LabourController::class, 'fetchLabourByDepartment'])->name('department.fetch');
    Route::post('milestone/fetch', [LabourController::class, 'fetchMilestones'])->name('milestone.fetch');
    Route::post('task/fetch', [LabourController::class, 'fetchTasks'])->name('task.fetch');
    ...
    Route::resource('projecttype', ProjectTypeController::class)->middleware(['auth', 'XSS']);
...
//    Route::get('/bill/{id}/', 'PurchaseController@purchaseLink')->name('purchase.link.copy');
    ...
    Route::get('project-labour-view', [ProjectWorkerRequestController::class, 'filterLabourProjectView'])->name('filter.projectlabour.view')->middleware(['auth', 'XSS']);

    Route::post('updateStatus', [ProjectWorkerRequestController::class, 'updateStatus'])->name('projectlabour.updateStatus')->middleware(['auth', 'XSS']);
    Route::resource('projectlabours', ProjectWorkerRequestController::class)->middleware(['auth', 'XSS']);

    Route::get('project-material-view', [ProjectMaterialRequestController::class, 'filterLabourProjectView'])->name('filter.projectmaterial.view')->middleware(['auth', 'XSS']);
    Route::post('materialUpdateStatus', [ProjectMaterialRequestController::class, 'updateStatus'])->name('projectmaterial.materialUpdateStatus')->middleware(['auth', 'XSS']);
    Route::resource('projectmaterials', ProjectMaterialRequestController::class)->middleware(['auth', 'XSS']);
